...
function MatSpinner__svg_circle_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("animation-name", "mat-progress-spinner-stroke-rotate-" + ctx_r2.diameter)("stroke-dashoffset", ctx_r2._getStrokeDashOffset(), "px")("stroke-dasharray", ctx_r2._getStrokeCircumference(), "px")("stroke-width", ctx_r2._getCircleStrokeWidth(), "%");
    ɵngcc0.ɵɵattribute("r", ctx_r2._getCircleRadius());
} }
function MatSpinner__svg_circle_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("stroke-dashoffset", ctx_r3._getStrokeDashOffset(), "px")("stroke-dasharray", ctx_r3._getStrokeCircumference(), "px")("stroke-width", ctx_r3._getCircleStrokeWidth(), "%");
    ɵngcc0.ɵɵattribute("r", ctx_r3._getCircleRadius());
} }
const BASE_SIZE = 100;
/**
